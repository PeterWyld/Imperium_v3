...
public class Utilities {
	//A collection of Utilites used in various parts of the program
			...
			try {
				...
				for(int i = 0; i <= numberOfLines -1; i++) {
					...
					for(int j = 0; j <= lineVals.length-1; j++) {
						try {
							returnInts[i][j] = intParseDefault(lineVals[j], 0);
	...
	public int intParseDefault(String input, int defaultValue) {
